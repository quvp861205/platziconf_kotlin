...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        /*val bottomNavView = findViewById<BottomNavigationView>(R.id.bnvMenu)
        val navHost = findNavController(R.id.nav_graph)
        bottomNavView.setupWithNavController(navHost)*/

        //NavigationUI.setupWithNavController(BottomNavigationView, Navigation.findNavController(this, R.id.fragmentContent))

        /*
        ESTE PEDAZO DE CODIGO PERMITE CREAR LOS DATOS EN FIRESTORE
        https://console.firebase.google.com/project/platziconfapp-81ac4/firestore/data/~2Fconferences~2F0hTF26hp4wlmsCmSLDN9
         */
